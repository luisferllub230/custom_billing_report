...
export class BillingTopSalespersonsChart extends Component {
    static template = "custom_billing_report.BillingTopSalespersonsChart";
    static props = {
        topSalespersons: { type: Array },
    ...
    setup() {
        ...
        useEffect(
            ...
            () => [this.props.topSalespersons, this.props.currencyId]
        );
    ...
    _renderChart() {
        ...
        const top = (this.props.topSalespersons || []).slice(0, 8);
